...
namespace zzz
{
    ...
    class red_black_tree : protected binary_search_tree<interface_t>
    {
    public:
        ...
        public:
            ...
            iterator &operator++()
            {
                ptr_ = red_black_tree::template bst_move_<true>(ptr_);
                return *this;
            }
            iterator &operator--()
            {
                ptr_ = red_black_tree::template bst_move_<false>(ptr_);
                return *this;
            }
    ...
    public:
        red_black_tree() : binary_search_tree<interface_t>(), size_()
        {
            set_black_(base_t::nil_(), true);
        }
        red_black_tree(red_black_tree const &other) = delete;
        red_black_tree &operator = (red_black_tree const &other) = delete;
